...
<!-- 	                                <input type="hidden" name="place" value="board"> -->
							...
							<a href="#" style="border:1px solid gainsboro; color: gray; border-radius: 10px;padding: 10px;" onclick="location.href='board'">목록으로</a>
                            </div>
                        </div>
                    </div>
                </div>
